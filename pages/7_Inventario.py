...
_mostrar_animacion_pagina = st.session_state.get("_ultima_pagina_animada") != "inventario"
st.session_state["_ultima_pagina_animada"] = "inventario"
_anim_pagina_css = (
    ...
    with st.form("form_nuevo_producto", clear_on_submit=True):
        ...
        with col_p2:
            ...
            if costo_p > 0 and venta_p > 0:
                ...
                st.caption(f"Ganancia: {formato_cop(ganancia)} ({pct:.1f}%)")
            ...
            if st.session_state.items_entrada_taller and st.button(
                ...
                if not items_validos:
                    ...
                    try:
                        ...
                        # scope="app": las métricas del encabezado (fuera de este
                        # fragment) también deben refrescarse tras registrar.
                        st.rerun(scope="app")
                    except Exception as e:
